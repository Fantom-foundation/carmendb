...
import (
	...
	"github.com/Fantom-foundation/carmendb/carmen"
	"github.com/Fantom-foundation/carmendb/carmen/experimental"
)

func TestConfigurations_ContainGoImplementations(t *testing.T) {
	goSeen := false
